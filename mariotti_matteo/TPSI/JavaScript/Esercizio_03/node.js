...
const query1 = db.prepare('SELECT * FROM Utente where eta >= 18 or eta == 16'); 


const res = query1.all();//eta >= 18 || eta == 16); //esegue SELECT * FROM Utente
...
const info6 = query4.run('Marco', 'Verdi', 16);
